    ...
    customers = this.actions$.pipe(
      ...
      switchMap(() => {
        return this.http.get <Customer []>(
          'https://morning-meadow-66437.herokuapp.com/https://roeibadur-customer-manager.herokuapp.com/Customers');
      }),
      map(customers => {
  ...
  @Effect({dispatch: false})
   stroingCustomers = this.actions$.pipe(
    ...
    switchMap(([actionData , customerState]) => {
      return this.http.put('https://morning-meadow-66437.herokuapp.com/https://roeibadur-customer-manager.herokuapp.com/Customers/Update',
